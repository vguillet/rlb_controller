...
class Goto:
    # -> Setup goto specs
    success_distance_range = success_distance_range
    success_angle_range = success_angle_range  # deg
    dynamic_success_angle_range_factor = dynamic_success_angle_range_factor
